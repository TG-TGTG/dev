function criarBarra(var_nome, var_avatar) {
  ...
  userBar.style.minWidth = "150px"; // Garantir que a largura mínima seja suficiente
  userBar.style.height = "50px"; // Ajuste a altura da barra
  userBar.style.zIndex = "9999"; // Garantir que a barra fique no topo
  userBar.style.backgroundColor = "rgba(255, 255, 255, 0.3)"; // Cor de fundo semi-transparente
  ...
  varStatus.style.color = "white"; // Garantir que a cor da fonte seja branca
